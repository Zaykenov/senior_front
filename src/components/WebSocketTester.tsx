  ...
  useEffect(() => {
    try {
      ...
      echo.connector.pusher.connection.bind('connected', () => {
        ...
        addMessage('connection', 'Connected to WebSocket server', { socketId: echo.socketId() });
      });
      ...
      if (echo.connector.pusher.connection.state === 'connected') {
        setConnectionStatus('connected');
        setSocketId(echo.socketId());
        addMessage('connection', 'Already connected to WebSocket server', { socketId: echo.socketId() });
      } else {
